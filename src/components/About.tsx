    ...
    <section className="py-24 md:py-40 px-6 relative overflow-hidden">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 md:gap-20 items-center">
        ...
        >
          ...
          <div className="w-20 h-1 bg-cyan-400 mb-8 md:mb-12" />
        </motion.div>
        ...
        <motion.div
          ...
          className="glass-card p-6 sm:p-10 rounded-3xl relative"
        >
          ...
          <div className="mt-8 md:mt-10 flex gap-8">
            <div>
              ...
              <p className="text-[10px] md:text-sm text-gray-500 uppercase tracking-widest">Years Exp</p>
            </div>
            <div>
              <p className="text-2xl md:text-3xl font-bold text-white">4</p>
              <p className="text-[10px] md:text-sm text-gray-500 uppercase tracking-widest">Projects</p>
            </div>
          </div>
        </motion.div>
      </div>
